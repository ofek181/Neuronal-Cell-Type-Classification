...
class FrequencyAnalyzer:
    ...
    def process_data(test_size: float = 0.2):
        ...
        return train_test_split(features, labels, test_size=test_size, random_state=7, shuffle=True)
    ...
    def objective(self, trial):
        n_filters = trial.suggest_categorical("n_filters", ([256, 256, 256],
                                                            ...
                                                            [64, 64, 64],
                                                            [32, 64, 128]))
        n_units = trial.suggest_categorical("n_units", ([256, 128, 64],
                                                        [128, 64, 32],
                                                        [64, 32, 16]))
        ...
        kernel_size = trial.suggest_categorical("kernel_size", (2, 3, 4, 5, 6))
        stride_size = trial.suggest_categorical("stride_size", (1, 2, 3, 4))
